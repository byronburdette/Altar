...
#include "RigUnit_InitLeaningBiped.generated.h"

USTRUCT(BlueprintType)
struct ANIMATIONNODERUNTIME_API FRigUnit_InitLeaningBiped : public FRigUnit_FeetIKBaseMutable {
    GENERATED_BODY()
public:
