#include "VLegacyAudioMenu.h"

UVLegacyAudioMenu::UVLegacyAudioMenu() {
}
...
void UVLegacyAudioMenu::SetSettings(const FLegacyAudioSettings& Value) {
}
...
FLegacyAudioSettings UVLegacyAudioMenu::GetSettings() const {
